...
assert.match(ui, /yani-home__ambient--service/);
assert.match(css, /\.yani-home__ambient \{/);
assert.match(css, /\.yani-home--reduced-motion \.yani-home__ambient \{ transition: none; transform: none; \}/);
