...
const modules = ['src/config.js', 'src/i18n.js', 'src/auth.js', 'src/api.js', 'src/catalog.js', 'src/stream-resolver.js', 'src/aniskip.js', 'src/ui-utils.js', 'src/yani-resolver.js', 'src/lampac-resolver.js', 'src/ui-media.js', 'src/ui-navigation.js', 'src/ui-schedule.js', 'src/ui-notifications.js', 'src/ui-auth.js', 'src/ui-status.js', 'src/ui-player.js', 'src/ui-account-lists.js', 'src/ui-home-sections.js', 'src/ui-collections.js', 'src/ui.js'];
