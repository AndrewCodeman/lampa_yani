...
const modules = ['src/config.js', 'src/i18n.js', 'src/genre-descriptions.js', 'src/auth.js', 'src/api.js', 'src/catalog.js', 'src/stream-resolver.js', 'src/aniskip.js', 'src/ui-utils.js', 'src/yani-resolver.js', 'src/lampac-resolver.js', 'src/ui-media.js', 'src/ui-navigation.js', 'src/ui-search.js', 'src/ui-catalog-filters.js', 'src/ui-catalog-controls.js', 'src/ui-card-renderers.js', 'src/ui-card-bind.js', 'src/ui-trailers.js', 'src/ui-schedule.js', 'src/ui-notifications.js', 'src/ui-auth.js', 'src/ui-status.js', 'src/ui-player.js', 'src/ui-account-list-controls.js', 'src/ui-account-lists.js', 'src/ui-home-sections.js', 'src/ui-home-insights.js', 'src/ui-collections.js', 'src/ui-releases.js', 'src/ui-recommendations.js', 'src/ui-updates.js', 'src/ui-translations.js', 'src/ui.js'];
